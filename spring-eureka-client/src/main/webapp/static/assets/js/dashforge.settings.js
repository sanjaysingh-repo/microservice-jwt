...
$(function(){
  ...
  $.ajax({
    ...
    success: function(result){
      ...
      if(hasMode) {
        $('head').append('<link id="dfMode" rel="stylesheet" href="static/assets/css/skin.'+hasMode+'.css">')
      ...
      if(hasSkin) {
        $('head').append('<link id="dfSkin" rel="stylesheet" href="static/assets/css/skin.'+hasSkin+'.css">')
  ...
  $('body').on('click', '.df-mode', function(e){
    ...
    if(!$(this).hasClass('disabled')) {
      ...
      if(mode === 'classic') {
        ...
        if($('#dfMode').length === 0) {
          if($('#dfSkin').length === 0) {
            $('head').append('<link id="dfMode" rel="stylesheet" href="static/assets/css/skin.'+mode+'.css">');
          } else {
            $('<link id="dfMode" rel="stylesheet" href="static/assets/css/skin.'+mode+'.css">').insertBefore($('#dfSkin'));
          }
        } else {
          $('#dfMode').attr('href', 'static/assets/css/skin.'+mode+'.css');
        }
  ...
  $('body').on('click', '.df-skin', function(e){
    ...
    if(skin === 'default') {
      ...
      if($('#dfSkin').length === 0) {
        $('head').append('<link id="dfSkin" rel="stylesheet" href="static/assets/css/skin.'+skin+'.css">')
      } else {
        $('#dfSkin').attr('href', 'static/assets/css/skin.'+skin+'.css');
      }
