            ...
            <div class="profile-sidebar profile-sidebar-two pd-lg-r-15">
              ...
              <div class="row">
                <div class="col-sm-3 col-md-2 col-lg">
                  <div class="avatar avatar-xxl avatar-online"><img src="static/assets/img/img16.jpg" class="rounded-circle" alt=""></div>
                </div><!-- col -->
            ...
            <div class="media-body mg-t-40 mg-lg-t-0 pd-lg-x-10">
              ...
              <div class="card mg-b-20 mg-lg-b-25">
                <div class="card-header pd-y-15 pd-x-20 d-flex align-items-center justify-content-between">
                  <h6 class="tx-13 tx-spacing-1 tx-uppercase tx-semibold mg-b-0">Latest Activity</h6>
                ...
                <div class="card-body pd-20 pd-lg-25">
                  <div class="media align-items-center mg-b-20">
                    <div class="avatar avatar-online"><img src="static/assets/img/img15.jpg" class="rounded-circle" alt=""></div>
              ...
              <div class="card mg-b-20 mg-lg-b-25">
                <div class="card-header pd-y-15 pd-x-20 d-flex align-items-center justify-content-between">
                  <h6 class="tx-13 tx-spacing-1 tx-uppercase tx-semibold mg-b-0">Work Experience</h6>
                  <nav class="nav nav-with-icon tx-13">
              ...
              <div class="card mg-b-20 mg-lg-b-25">
                <div class="card-header pd-y-15 pd-x-20 d-flex align-items-center justify-content-between">
                  <h6 class="tx-13 tx-spacing-1 tx-uppercase tx-semibold mg-b-0">Education</h6>
                  <nav class="nav nav-with-icon tx-13">
                    <a href="#" class="nav-link"><i data-feather="plus"></i> Add New</a>
                  </nav>
                </div><!-- card-header -->
              ...
              <div class="card card-profile-interest">
                <div class="card-header pd-y-15 pd-x-20 d-flex align-items-center justify-content-between">
                  <h6 class="tx-13 tx-spacing-1 tx-uppercase tx-semibold mg-b-0">Interests</h6>
                  <nav class="nav nav-with-icon tx-13">
              ...
              <div class="row">
                <div class="col-sm-6 col-md-5 col-lg">
                  ...
                  <ul class="list-unstyled media-list mg-b-15">
                    ...
                    <li class="media align-items-center">
                      <a href="#"><div class="avatar avatar-offline"><img src="static/assets/img/img8.jpg" class="rounded-circle" alt=""></div></a>
                      <div class="media-body pd-l-15">
                ...
                <div class="col-sm-6 col-md-5 col-lg mg-t-40 mg-sm-t-0 mg-lg-t-40">
                  ...
                  <ul class="list-unstyled media-list mg-b-15">
                    <li class="media align-items-center">
                      <a href="#"><div class="avatar avatar-online"><img src="static/assets/img/img6.jpg" class="rounded-circle" alt=""></div></a>
                      <div class="media-body pd-l-15">
                    ...
                    <li class="media align-items-center">
                      <a href="#"><div class="avatar avatar-offline"><img src="static/assets/img/img7.jpg" class="rounded-circle" alt=""></div></a>
                      <div class="media-body pd-l-15">
                ...
                <div class="col-sm-6 col-md-5 col-lg mg-t-40">
                  ...
                  <ul class="list-unstyled media-list mg-b-15">
                    <li class="media align-items-center">
                      <a href="#"><div class="avatar"><img src="static/assets/img/img21.jpg" class="rounded-circle" alt=""></div></a>
                      <div class="media-body pd-l-15">
                    ...
                    <li class="media align-items-center">
                      <a href="#"><div class="avatar"><img src="static/assets/img/img22.jpg" class="rounded-circle" alt=""></div></a>
                      <div class="media-body pd-l-15">
                    ...
                    <li class="media align-items-center">
                      <a href="#"><div class="avatar"><img src="static/assets/img/img23.jpg" class="rounded-circle" alt=""></div></a>
                      <div class="media-body pd-l-15">
                    ...
                    <li class="media align-items-center">
                      <a href="#"><div class="avatar"><img src="static/assets/img/img24.jpg" class="rounded-circle" alt=""></div></a>
                      <div class="media-body pd-l-15">
                    ...
                    <li class="media align-items-center">
                      <a href="#"><div class="avatar"><img src="static/assets/img/img25.jpg" class="rounded-circle" alt=""></div></a>
                      <div class="media-body pd-l-15">
                ...
                <div class="col-sm-6 col-md-5 col-lg mg-t-40 order-sm-1">
                  ...
                  <div class="img-group img-group-mutual mg-b-20 justify-content-start">
                    <img src="static/assets/img/img10.jpg" class="img rounded-circle" alt="">
                    <img src="static/assets/img/img11.jpg" class="img rounded-circle" alt="">
                    <img src="static/assets/img/img12.jpg" class="img rounded-circle" alt="">
                    <img src="static/assets/img/img13.jpg" class="img rounded-circle" alt="">
                    <img src="static/assets/img/img9.jpg" class="img rounded-circle" alt="">
                  </div>
                ...
                <div class="col-sm-6 col-md-5 col-lg mg-t-40">
                  ...
                  <div class="row row-xxs">
                    <div class="col-4">
                      <a href="#" class="d-block ht-60"><img src="static/assets/img/img2.jpg" class="img-fit-cover" alt=""></a>
                    </div><!-- col -->
                    <div class="col-4">
                      <a href="#" class="d-block ht-60"><img src="static/assets/img/img3.jpg" class="img-fit-cover" alt=""></a>
                    </div><!-- col -->
                    <div class="col-4">
                      <a href="#" class="d-block ht-60"><img src="static/assets/img/img4.jpg" class="img-fit-cover" alt=""></a>
                    </div><!-- col -->
                    <div class="col-4 mg-t-2">
                      <a href="#" class="d-block ht-60"><img src="static/assets/img/img5.jpg" class="img-fit-cover" alt=""></a>
                    </div><!-- col -->
                    <div class="col-4 mg-t-2">
                      <a href="#" class="d-block ht-60"><img src="static/assets/img/img6.jpg" class="img-fit-cover" alt=""></a>
                    </div><!-- col -->
                    <div class="col-4 mg-t-2">
                      <a href="#" class="d-block ht-60"><img src="static/assets/img/img7.jpg" class="img-fit-cover" alt=""></a>
                    </div><!-- col -->
                    <div class="col-4 mg-t-2">
                      <a href="#" class="d-block ht-60"><img src="static/assets/img/img18.jpg" class="img-fit-cover" alt=""></a>
                    </div><!-- col -->
                    <div class="col-4 mg-t-2">
                      <a href="#" class="d-block ht-60"><img src="static/assets/img/img19.jpg" class="img-fit-cover" alt=""></a>
                    </div><!-- col -->
                    <div class="col-4 mg-t-2">
                      <a href="#" class="d-block ht-60"><img src="static/assets/img/img20.jpg" class="img-fit-cover" alt=""></a>
                    </div><!-- col -->
                  </div><!-- row -->
                </div><!-- col -->
              </div><!-- row -->
