      ...
      <div class="aside-body">
        <div class="aside-loggedin">
          <div class="d-flex align-items-center justify-content-start">
            <a href="#" class="avatar"><img src="static/assets/img/img1.png" class="rounded-circle" alt=""></a>
        ...
        <ul class="nav nav-aside">
          ...
          <li class="nav-item"><a href="../../components/index.html" class="nav-link"><i data-feather="layers"></i> <span>Components</span></a></li>
          <li class="nav-item"><a href="../../collections/index.html" class="nav-link"><i data-feather="box"></i> <span>Collections</span></a></li>
        </ul>
      </div>
    </aside>